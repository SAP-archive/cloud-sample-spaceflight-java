...
<edmx:Edmx 
    ...
    <edmx:DataServices>
        <Schema 
            xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Org.OData.Core.V1" Alias="Core">
            ...
            <Term Name="OptimisticConcurrency" Type="Collection(Edm.PropertyPath)" DefaultValue="" Nullable="false" AppliesTo="EntitySet">
            ...
            <ComplexType Name="Dictionary" OpenType="true">
                ...
                <Annotation Term="Core.LongDescription" String="Names must be simple identifiers, values may be restricted via an annotation with term Validation.OpenPropertyTypeConstraint"/>
            </ComplexType>
            ...
            <Term Name="OperationAvailable" Type="Edm.Boolean" DefaultValue="true" AppliesTo="Action Function">
                ...
                <Annotation Term="Core.LongDescription" String="The annotation value will usually be an expression, e.g. using properties of the binding parameter type for instance-dependent availability, or using properties of a singleton for global availability."/>
            </Term>
        </Schema>
    </edmx:DataServices>
</edmx:Edmx>