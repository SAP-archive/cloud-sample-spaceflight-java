...
<edmx:Edmx 
  ...
  <edmx:DataServices>
    <Schema 
      xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="com.sap.vocabularies.Common.v1" Alias="Common">
      ...
      <Annotation Term="Core.Links">
        <Collection>
          <Record>
            ...
            <PropertyValue Property="href" String="https://wiki.scn.sap.com/wiki/download/attachments/448470974/Common.xml?api=v2"/>
          </Record>
        </Collection>
      </Annotation>
      <!-- Section: Versioning -->
      ...
      <!-- under discussion
        <Term Name="ValidationConstraint" Type="Common.ValidationConstraintType" AppliesTo="Property EntityType ComplexType"><Annotation Term="Core.Description" String="Condition that the annotation target has to fulfill" /></Term><ComplexType Name="ValidationConstraintType"><Property Name="FailureMessage" Type="Edm.String" Nullable="true"><Annotation Term="Core.IsLanguageDependent" /></Property><Property Name="Condition" Type="Edm.Boolean"><Annotation Term="Core.Description" String="Value MUST be a dynamic expression that evaluates to true if and only if the constraint is fulfilled" /></Property></ComplexType>
      -->
      <!-- Examples:
        <Annotation Term="Common.ValidationConstraint" Qualifier="Comparison"><Record><PropertyValue Property="FailureMessage" String="Start date cannot be after end date" /><PropertyValue Property="Condition"><Le><Path>StartDate</Path><Path>EndDate</Path></Le></PropertyValue></Record></Annotation><Annotation Term="Common.ValidationConstraint" Qualifier="Minimum"><Record><PropertyValue Property="FailureMessage" String="Value cannot be negative" /><PropertyValue Property="Condition"><Ge><Path>Amount</Path><Decimal>0</Decimal></Ge></PropertyValue></Record></Annotation>
      -->
      <!--
      ...
      <Term Name="SemanticObjectMapping" BaseTerm="Common.SemanticObject" Type="Collection(Common.SemanticObjectMappingType)" AppliesTo="EntitySet EntityType Property">
      ...
      <Term Name="ResultContext" Type="Core.Tag" DefaultValue="true" AppliesTo="EntityType">
        <Annotation Term="Core.Description">
          ...
          An instance of the annotated entity type provides the context required for determining           the target entity sets reached by these containment navigation properties.</String>
        </Annotation>
      </Term>
      <!-- Section: Value Help -->
      ...
      <ComplexType Name="ValueListType">
        ...
        <Property Name="PresentationVariantQualifier" Type="Common.SimpleIdentifier">
          ...
          <Annotation Term="Core.LongDescription" String="Qualifier for annotation with term com.sap.vocabularies.UI.v1.PresentationVariant on the entity set identified via CollectionPath"/>
        </Property>
      ...
      <Term Name="ValueListWithFixedValues" Type="Core.Tag" DefaultValue="true" AppliesTo="Property Parameter">
      ...
      <Term Name="ValueListMapping" Type="Common.ValueListMappingType" AppliesTo="Property Parameter">
        ...
        <Annotation Term="Core.LongDescription" String="The value list can be filtered based on user input. It can be used for type-ahead and classical pick lists. There may be many alternative mappings with different qualifiers. The qualifier-less mapping is the default value list."/>
      </Term>
      <ComplexType Name="ValueListMappingType">
        ...
        <Property Name="PresentationVariantQualifier" Type="Common.SimpleIdentifier">
          <Annotation Term="Core.Description" String="Alternative representation of a value help, e.g. as a bar chart"/>
          <Annotation Term="Core.LongDescription" String="Qualifier for annotation with term com.sap.vocabularies.UI.v1.PresentationVariant on the value list entity set identified via CollectionPath in the ValueListReference annotation"/>
        </Property>
        <Property Name="Parameters" Type="Collection(Common.ValueListParameter)" Nullable="false">
          <Annotation Term="Core.Description" String="Instructions on how to construct the value list request and consume response properties"/>
        </Property>
      ...
      <Term Name="IsCalendarYear" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a year number as string following the logical pattern (-?)YYYY(Y*) consisting of an optional           minus sign for years B.C. followed by at least four digits. The string matches the regex pattern -?([1-9][0-9]{3,}|0[0-9]{3})
          </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
      ...
      <Term Name="IsCalendarQuarter" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar quarter number as string following the logical pattern Q consisting of a single digit.           The string matches the regex pattern [1-4]
          </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      ...
      <Term Name="IsCalendarMonth" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar month number as string following the logical pattern MM consisting of two digits.           The string matches the regex pattern 0[1-9]|1[0-2]
          </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      ...
      <Term Name="IsCalendarWeek" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar week number as string following the logical pattern WW consisting of two digits.           The string matches the regex pattern 0[1-9]|[1-4][0-9]|5[2-3]           </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      </Term>
      <Term Name="IsDayOfCalendarMonth" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Day number relative to a calendar month. Valid values are between 1 and 31.            </String>
        </Annotation>
      ...
      <Term Name="IsDayOfCalendarYear" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Day number relative to a calendar year. Valid values are between 1 and 366.            </String>
        </Annotation>
      ...
      <Term Name="IsCalendarYearHalfyear" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar year and halfyear as string following the logical pattern (-?)YYYY(Y*)H consisting           of an optional minus sign for years B.C. followed by at least five digits, where the last digit represents the halfyear.
      ...
      <Term Name="IsCalendarYearQuarter" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar year and quarter as string following the logical pattern (-?)YYYY(Y*)Q consisting           of an optional minus sign for years B.C. followed by at least five digits, where the last digit represents the quarter.
      ...
      <Term Name="IsCalendarYearMonth" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar year and month as string following the logical pattern (-?)YYYY(Y*)MM consisting           of an optional minus sign for years B.C. followed by at least six digits, where the last two digits represent the months January to December.
      ...
      <Term Name="IsCalendarYearWeek" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar year and week as string following the logical pattern (-?)YYYY(Y*)WW consisting           of an optional minus sign for years B.C. followed by at least six digits, where the last two digits represent week number in the year.
          The string matches the regex pattern -?([1-9][0-9]{3,}|0[0-9]{3})(0[1-9]|[1-4][0-9]|5[2-3])           </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      </Term>
      <Term Name="IsCalendarDate" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a calendar date: year, month and day as string following the logical pattern (-?)YYYY(Y*)MMDD consisting           of an optional minus sign for years B.C. followed by at least eight digits, where the last four digits represent           the months January to December (MM) and the day of the month (DD).
          ...
          The day value must be no more than 30 if month is one of 04, 06, 09, or 11, no more than 28 if month is 02 and year is not divisible by 4,           or is divisible by 100 but not by 400, and no more than 29 if month is 02 and year is divisible by 400, or by 4 but not by 100.                    </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      </Term>
      ...
      <Term Name="IsFiscalYear" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a fiscal year number as string following the logical pattern YYYY(Y*) consisting of at least four digits.           The string matches the regex pattern [1-9][0-9]{3,}
          </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      ...
      <Term Name="IsFiscalPeriod" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a fiscal period as string following the logical pattern PPP consisting of three digits.           The string matches the regex pattern [0-9]{3}
          </String>
        </Annotation>
        <Annotation Term="Core.RequiresType" String="Edm.String"/>
        <Annotation Term="Common.MutuallyExclusiveTerm" Qualifier="DatePart"/>
      ...
      <Term Name="IsFiscalYearPeriod" Type="Core.Tag" DefaultValue="true" AppliesTo="Property">
        <Annotation Term="Core.Description">
          <String>Property encodes a fiscal year and period as string following the logical pattern YYYY(Y*)PPP consisting           of at least seven digits, where the last three digits represent the fiscal period in the year.
      ...
      <ComplexType Name="DraftRootType" BaseType="Common.DraftNodeType">
        ...
        <Property Name="NewAction" Type="Common.QualifiedName">
          <Annotation Term="Core.Description" String="Action that creates a new draft. It may have overloads that allow referencing other business documents that are used to pre-fill the new draft"/>
        </Property>
      </ComplexType>
...
only TargetProperties and TargetEntities are relevant. They are addressed via the binding parameter of the action.</String>
        ...
        <Property Name="SourceEntities" Type="Collection(Edm.NavigationPropertyPath)">
          <Annotation Term="Core.Description" String="Changes to one or more of these entities will affect the targets. An empty path means the annotation target."/>
        </Property>
        ...
        <Property Name="TargetEntities" Type="Collection(Edm.NavigationPropertyPath)">
          <Annotation Term="Core.Description" String="These entities will be affected if the value of one of the sources changes. An empty path means the annotation target."/>
        </Property>
...
Upon modification field control logic is invoked so that meta-information like hidden or read-only is determined.</String>
      ...
      <Term Name="SortOrder" Type="Collection(Common.SortOrderType)" AppliesTo="EntitySet EntityType">
        ...
        <Annotation Term="Core.LongDescription">
          <String>The items of the annotated entity set or the items of the           collection of the annotated entity type are sorted by the first entry of the SortOrder collection.           Items with same value for this first sort criteria are sorted by the second entry of the SortOrder collection, and so on. </String>
        </Annotation>
      </Term>
      ...
      <!-- under discussion with Heiko Theissen, Heiko Gerwens, Christoph Glania, and Ralf Dentzer
        <Term Name="CacheControlProposal" Type="Common.CacheControlProposalType" AppliesTo="EntitySet"><Annotation Term="Core.Description"><String>Proposed values for the Cache-Control request header when accessing this entity set, see https://tools.ietf.org/html/rfc7234#section-5.2.1</String></Annotation></Term><ComplexType Name="CacheControlProposalType"><Property Name="MaxAge" Type="Edm.Int32"><Annotation Term="Core.Description" String="Maximum acceptable age of the response in seconds, see https://tools.ietf.org/html/rfc7234#section-5.2.1.1" /></Property></ComplexType>
      -->
      ...
      <ComplexType Name="RecursiveHierarchyType">
        ...
        <Property Name="NodeDescendantCountProperty" Type="Edm.PropertyPath">
          <Annotation Term="Core.Description">
            <String>Property holding the descendant count for a hierarchy node.             The descendant count of a node is the number of its descendants in the hierarchy structure of the result considering             only those nodes matching any specified $filter and $search. A property holding descendant counts has an integer             data type.</String>
          </Annotation>
        </Property>
        <Property Name="NodeDrillStateProperty" Type="Edm.PropertyPath">
          <Annotation Term="Core.Description">
            <String>Property holding the drill state of a hierarchy node. The drill state is indicated             by one of the following string values: collapsed, expanded, or leaf. For an expanded node, its             children are included in the result collection. For a collapsed node, the children are included in the entity set, but             they are not part of the result collection. Retrieving them requires a relaxed filter expression or a separate request             filtering on the parent node ID with the ID of the collapsed node. A leaf does not have any child in the entity set.
            </String>
          </Annotation>
        </Property>
      </ComplexType>
