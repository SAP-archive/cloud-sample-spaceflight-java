...
const V4JsonLiteralEncoder = require('../../lib/utils/V4JsonLiteralEncoder');
const EdmPrimitiveTypeKind = require('../../../lib/edm/EdmPrimitiveTypeKind');

describe(__filename, () => {
    describe('should test V4JsonLiteralEncoder.encode()', () => {
        ...
        for (const test of testdata) {
            it(test.title, () => {
                const encoder = new V4JsonLiteralEncoder();
