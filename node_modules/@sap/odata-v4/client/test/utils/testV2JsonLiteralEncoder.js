...
const V2JsonLiteralEncoder = require('../../lib/utils/V2JsonLiteralEncoder');
const EdmPrimitiveTypeKind = require('../../../lib/edm/EdmPrimitiveTypeKind');

describe(__filename, () => {

    describe('V2JsonLiteralEncoder', () => {
        ...
        describe('.encode() positive cases', () => {
            const testdata = [
                ...
                },
                {
                    ...
                    type: EdmPrimitiveTypeKind.Double,
                    expected: Number.MAX_VALUE.toString()
                },
                {
                    value: Number.MIN_VALUE,
                    type: EdmPrimitiveTypeKind.Double,
                    expected: Number.MIN_VALUE.toString()
                },
                {
                    value: -Number.MAX_VALUE,
                    type: EdmPrimitiveTypeKind.Double,
                ...
                },
                {
                    ...
                    type: EdmPrimitiveTypeKind.Guid,
                    expected: 'abcdefab-cdef-feba-cdba-fedcbaabcdcc'
                },
                {
                    value: '12345678-4321-9876-1245-123456789012',
                    type: EdmPrimitiveTypeKind.Guid,
                    expected: '12345678-4321-9876-1245-123456789012'
                },
                // Int16
                {
                    value: -32768,
                ...
                },
                {
                    ...
                    type: EdmPrimitiveTypeKind.Single,
                    expected: '1.401298464324817e-45'
                },
                {
                    value: -3.4028234663852886E+38,
                    type: EdmPrimitiveTypeKind.Single,
                ...
                // Date
                {
                    ...
                    expected: '/Date(1512000000000)/'
                },
                {
                    value: '0001-12-31',
                    type: EdmPrimitiveTypeKind.Date,
                    expected: '/Date(-62104147200000)/'
                },
                // DateTimeOffset
                {
                    value: '2017-11-30T13:24Z',
                    type: EdmPrimitiveTypeKind.DateTimeOffset,
                    expected: '/Date(1512048240000)/'
                },
                {
                    value: '2017-11-30T13:24:36Z',
                    type: EdmPrimitiveTypeKind.DateTimeOffset,
                    expected: '/Date(1512048276000)/'
                },
                {
                    value: '2017-11-30T13:24:36.123Z',
                    type: EdmPrimitiveTypeKind.DateTimeOffset,
                    expected: '/Date(1512048276123)/'
                },
                {
                    value: '2017-11-30T13:24:36+01:00',
                    type: EdmPrimitiveTypeKind.DateTimeOffset,
                    expected: '/Date(1512044676000)/'
                },
                {
                    value: '2017-11-30T13:24:36-01:00',
                    type: EdmPrimitiveTypeKind.DateTimeOffset,
                    expected: '/Date(1512051876000)/'
                },
                // TimeOfDay
                {
                    value: '23:59:59.00000',
                    type: EdmPrimitiveTypeKind.TimeOfDay,
                    expected: 'PT23H59M59.00000S'
                },
                {
                    value: '23:59:59',
                    type: EdmPrimitiveTypeKind.TimeOfDay,
            ...
            const test = data => {
                it(`should encode "${data.value}" with kind "${data.type}" to literal "${data.expected}"`, () => {
                    const encoded = new V2JsonLiteralEncoder().encode(data.value, data.type);
        ...
        describe('.encode() negative cases', () => {
            ...
            const test = data => {
                it(`should fail to encode "${data.value}" with kind "${data.type}"`, () => {
                    assert.throws(() => {
                        new V2JsonLiteralEncoder().encode(data.value, data.type);
                    });
                });
            };
